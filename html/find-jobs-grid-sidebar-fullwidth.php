...
?>
  <section>
    <div class="tf-container ctn-full wrap-sidebar-full pl1">
      <div class="row">
        <div class="col-lg-3">
          <div class="content-left style2 po-sticky">
            <div class="inner st-filter">
              <div class="widget-filter style-scroll">
        ...
        <div class="col-lg-9 tf-tab">
          <div class="wd-meta-select-job">

            <div class="wd-findjob-filer">
              <div class="group-select-display">
                <div class="inner menu-tab">
                  <a class="btn-display current active"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16"
          ...
          <div class="content-tab style-scroll">
            <div class="inner">
              <div class="group-col-3">
                ...
                <div class="features-job cl3">
                  <div class="job-archive-header">
                    <div class="inner-box">
                      <div class="logo-company">
                        <img src="images/logo-company/cty10.png" alt="images/logo-company/cty9.png">
                      </div>
                      <div class="box-content">
                        <h4>
                          <a href="jobs-single.html">Rockstar Games New York</a>
                ...
                <div class="features-job cl3">
                  <div class="job-archive-header">
                    <div class="inner-box">
                      <div class="logo-company">
                        <img src="images/logo-company/cty4.png" alt="images/logo-company/cty10.png">
                      </div>
                      <div class="box-content">
                        <h4>
                          <a href="jobs-single.html">Rockstar Games New York</a>
          ...
          <ul class="pagination-job absolute">
...
<!-- Mirrored from themesflat.co/html/jobtex/find-jobs-grid-sidebar-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:28:33 GMT -->
</html>