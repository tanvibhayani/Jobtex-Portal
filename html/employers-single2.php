...
?>
  ...
  <section class="inner-employer-section">
    <div class="tf-container">
      <div class="row">
        <div class="col-lg-8">
          <div class="wd-job-author stc-em2 form-sticky fixed-space">
            <div class="inner-job-left">
              <img src="images/logo-company/cty4.png" alt="images/logo-company/cty4.png" class="logo-company">
              <div class="content">
                <h3><a href="#">Avitex Agency</a><span class="icon-bolt"></span></h3>
                <div class="job-info">
                ...
                <div class="group-btn">
                  ...
                  <button class="tf-btn">2 job openings</button>
                </div>
              </div>
            </div>
            <div class="inner-job-right">
              <span class="icon-share2"></span>
              <div class="group-btn">
                <button class="tf-btn-submit btn-popup">Write a review</button>
                <button class="tf-btn">Message</button>
              </div>
            </div>
          </div>
          <article class="job-article tf-tab single-job single-employer">
            <ul class="menu-tab">
              <li class="ct-tab">About</li>
            ...
            <div class="content-tab">
              <div class="inner-content">
                    ...
                    <div class="job-archive-header">
                      <div class="inner-box">
                        ...
                        <div class="box-content">
                          <h4>
                            <a href="employers-single.html">Tamari Law Group LLC</a>
                          </h4>
                          <h3>
                            <a href="employers-single.html">HR Administration</a>
                ...
                <div class="job-rating">
                  ...
                  <ul class="client-review">
                    <li class="client-item">
                      <div class="content">
                        ...
                        <a href="#" class="btn-like">Was this helpful? <svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a href="#" class="btn-load">See more reviews (719)</a>
                </div>
        ...
        <div class="col-lg-4">
          <div class="cv-form-details st2 po-sticky">
