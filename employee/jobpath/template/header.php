...
<header class="rts__section rts__header absolute__header">
    ...
    <nav class="navigation__menu" id="offcanvas__menu">
        <ul class="list-unstyled">
            ...
            &nbsp; &nbsp; &nbsp;
            <li class="sub__style">
                <a href="employer-all-candidates.php" class="navigation__menu--item__link">Candidates</a>
            ...
            <li class="navigation__menu--item has-child has-arrow">
                ...
                <ul class="submenu sub__style" role="menu">
                   <li role="menuitem"><a href="blog-manage.php">Manage Blog</a></li>
                     <li role="menuitem"><a href="blog-add.php">Add Blog</a></li>
                        <!-- <ul class="sub__style" role="menu">
                    ...
                    <li role="menuitem"><a href="faq.php">Faq</a></li>
                    <li role="menuitem"><a href="tos.php">Terms &amp; Conditions</a></li>
            ...
            <li class="navigation__menu--item has-child has-arrow">
                ...
                <ul class="submenu sub__style" role="menu">
                   <!-- <li role="menuitem"><a href="blog-add.php">Blog</a></li> -->
                        <!-- <ul class="sub__style" role="menu">
