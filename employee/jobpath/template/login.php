      ...
      <div class="max-content similar__form form__padding">
        ...
        <form method="post" class="d-flex flex-column gap-3" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <label for="image" class="fw-medium text-dark mb-3">Photo</label>
            <div class="position-relative">
...
if (isset($_POST['signup_btn'])) {
    ...
    $image_folder = "../../../images/";  // go up 2 levels to reach 'images' folder
    $image_path = $image_folder . $image_name;

    // Check if email exists
    $check = mysqli_query($con, "SELECT * FROM e_registration WHERE email='$email'");
    if (mysqli_num_rows($check) > 0) {
        echo "<script>alert('Email already registered!');</script>";
    } else {
        if (move_uploaded_file($image_tmp, $image_path)) {
            $query = "INSERT INTO e_registration(name, email, password, profile_image) 
