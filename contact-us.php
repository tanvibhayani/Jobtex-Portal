                    ...
                    <div class="group-contact-us">
                        <div class="infor-contact-v1">
                            ...
                            <div class="icon-inforr">
                                ...
                                <div class="content">
                                    <h6>Address</h6>
                                    <p>Sardarpur Rode, Moravada-362020</p>
                                </div>
                            </div>
                        ...
                        <div class="form-candidate">
                            <form method="post">
                              ...
                              <div class="ip out">
                                <textarea placeholder="Your questions..." name="question"></textarea>
                              </div>
...
<?php
    if(isset($_POST['sub']))
    {
        ...
        $qry="INSERT INTO contact(name,subject,email,question)VALUES('$name','$subject','$email','$question')";
