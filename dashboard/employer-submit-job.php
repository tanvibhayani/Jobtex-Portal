...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-submit-job.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:40 GMT -->
<head>
  <!-- Basic Page Needs -->
...
<body class="dashboard show ">
  ...
  <div class="dashboard__content">
    <section class="page-title-dashboard style">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="title-dashboard  flex2">
              <div class="title-box">
                <div class="title-dash flex2">Submit Job</div>
              </div>
              <div class="tt-button">
                <a href="#">Continue Using Quota</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="flat-dashboard-submit">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="submit-job">
              <h3>Your Package</h3>
              <div class="package-wrap flex">
                <div class="box box-1 flex2">
                  <input class="radio-out" type="radio" name="fav_language" value="HTML">
                    <div class="content ">
                    <h4 class=" fw-7">Basic</h4>
                    <h5 class="color-4">30 Job posting, Job displayed for 15 days</h5>
                  </div>
                </div>
                <div class="box box-1 flex2">
                  <input class="radio-out" type="radio" name="fav_language" value="">
                   <div class="content ">
                    <h4 class="fw-7">Extended</h4>
                    <h5>30 Job posting, Job displayed for 15 days</h5>
                  </div>
                   
                </div>
                <div class="box box-1 flex2">
                ...
                <div class="box box-1 flex2">
                  <input type="radio" class="radio-out" name="fav_language" value="">
                   <div class="content ">
                    <h4 class="fw-7">Extended</h4>
                    <h5>30 Job posting, Job displayed for 15 days</h5>
                  </div>
      ...
      <div class="wprt-spacer clearfix" data-desktop="41" data-mobi="20" data-smobi="15"></div>
    </section>

    <section class="flat-dashboard-month">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
          ...
          <div class="col-lg-4 col-md-4 ">
            <div class="wrap-month">
              <h4 class="titles fw-7">Basic</h4>
              <div class="money-box flex"><span class="fw-6">$19.00</span>
                <h5>/month</h5>
              </div>
              <ul>
                <li><span>30 Job posting</span> </li>
                <li><span>3 featured job</span></li>
                <li><span>Job displayed for 15 days</span></li>
          ...
          <div class="col-lg-4 col-md-4 ">
            <div class="wrap-month active">
              <div class="titles-box flex">
                <h4 class="titles fw-7">Standard</h4>
                <div class="sub-titles fw-7"><a>Popular</a> </div>
              </div>

              <div class="money-box flex"><span class="fw-6">$39.00</span>
                <h5>/month</h5>
              </div>
              <ul>
                <li><span>40 Job posting</span> </li>
                <li><span>5 featured job</span></li>
                <li><span>Job displayed for 30 days</span></li>
                <li><span>Premium Support 24/7</span></li>
              </ul>
              <div class="tt-button">
                <a href="#">Browse Themes</a>
          ...
          <div class="col-lg-4 col-md-4 ">
            <div class="wrap-month">
              <h4 class="titles fw-7">Extended</h4>
              <div class="money-box flex"><span class="fw-6">$79.00</span>
                <h5>/month</h5>
              </div>
              <ul>
                <li><span>50 Job posting</span> </li>
                <li><span>10 featured job</span></li>
                <li><span>Job displayed for 60 days</span></li>
                <li><span>Premium Support 24/7</span></li>
              </ul>
              <div class="tt-button">
                <a href="#">Browse Themes</a>
