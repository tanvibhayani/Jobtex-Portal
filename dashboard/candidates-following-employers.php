...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/candidates-following-employers.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:32 GMT -->
<head>
  <!-- Basic Page Needs -->
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="title-dashboard">
              <div class="title-dash flex2">Following Employers</div>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <tbody>
                      ...
                      <tr class="file-delete">
                        ...
                        <td>
                          <div class="action-wrap">
                            <ul class="flex2">
                              <li><a class="button-cancel fw-7">5 job openings</a></li>
                              <li><a class="button-cancel fw-7 remove-file btn-3">Unfollow</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr class="file-delete">
                        ...
                        <td>
                          <div class="action-wrap">
                            <ul class="flex2">
                              <li><a class="button-cancel fw-7">4 job openings</a></li>
                              <li><a class="button-cancel fw-7 remove-file btn-3">Unfollow</a></li>
                            </ul>
                          </div>
                        </td>
                      ...
                      <tr class="file-delete">
                        ...
                        <td>
                          <div class="action-wrap">
                            <ul class="flex2">
                              <li><a class="button-cancel fw-7">2 job openings</a></li>
                              <li><a class="button-cancel fw-7 remove-file btn-3">Unfollow</a></li>
                            </ul>
                          </div>
                        </td>
                      ...
                      <tr class="file-delete">
                        ...
                        <td>
                          <div class="action-wrap">
                            <ul class="flex2">
                              <li><a class="button-cancel fw-7">0 job openings</a></li>
                              <li><a class="button-cancel fw-7 remove-file btn-3">Unfollow</a></li>
                            </ul>
                          </div>
                        </td>
