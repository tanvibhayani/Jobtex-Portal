...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/candidates-meetings.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:32 GMT -->
<head>
  <!-- Basic Page Needs -->
              ...
              <div class="header-customize-item account">
                ...
                <div class="sub-account">
                  <div class="sub-account-item">
                    <a href="candidates-dashboard.php"><span class="icon-dashboard"></span>Dashboard</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-profile-setting.php"><span class="icon-profile"></span> Profile</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-resumes.php"><span class="icon-resumes"></span> Resumes</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-my-applied.php"><span class="icon-my-apply"></span> My Applied</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-save-jobs.php"><span class="icon-work"></span> Saved Jobs</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-alerts-jobs.php"><span class="icon-bell1"></span> Candidate Alerts</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-messages.php"><span class="icon-chat"></span> Messages</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-following-employers.php"><span class="icon-following"></span> Following
                      Employers</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-meetings.php"><span class="icon-meeting"></span> Meeting</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-change-passwords.php"><span class="icon-change-passwords"></span> Change
                      Passwords</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="candidates-delete-profile.php"><span class="icon-trash"></span> Delete Profile</a>
                  </div>
                  <div class="sub-account-item">
  ...
  <div class="left-menu">
    ...
    <div id="sidebar-menu">
      <ul class="downmenu list-unstyled" id="side-menu">
        <li>
          <a href="candidates-dashboard.php" class="tf-effect">
        ...
        <li>
          ...
          <ul class="sub-menu2" aria-expanded="false">
            <li><a href="candidates-overview.php">Overview</a></li>
            <li><a href="candidates-profile-setting.php">Profile Setting</a></li>
          </ul>
        </li>
        <li>
          <a href="candidates-resumes.php" class="tf-effect">
            <span class="icon-resumes dash-icon"></span>
            <span class="dash-titles">Resumes</span>
          </a>
        </li>
        <li>
          <a href="candidates-my-applied.php" class="tf-effect">
            <span class="icon-my-apply dash-icon"></span>
            <span class="dash-titles">My Applied</span>
          </a>
        </li>
        <li>
          <a href="candidates-save-jobs.php" class="tf-effect">
            <span class="icon-work dash-icon"></span>
            <span class="dash-titles">Saved Jobs</span>
          </a>
        </li>
        <li>
          <a href="candidates-alerts-jobs.php" class="tf-effect">
            <span class="icon-bell1 dash-icon"></span>
            <span class="dash-titles">Alerts Jobs</span>
          </a>
        </li>
        <li>
          <a href="candidates-messages.php" class="tf-effect">
            <span class="icon-chat dash-icon"></span>
            <span class="dash-titles">Messages</span>
          </a>
        </li>
        <li>
          <a href="candidates-following-employers.php" class="tf-effect">
            <span class="icon-following dash-icon"></span>
            <span class="dash-titles">Following Employers</span>
          </a>
        </li>
        <li>
          <a href="candidates-meetings.php" class="tf-effect">
            <span class="icon-meeting dash-icon"></span>
            <span class="dash-titles">Meeting</span>
          </a>
        </li>
        <li>
          <a href="candidates-change-passwords.php" class="tf-effect">
            <span class="icon-change-passwords dash-icon"></span>
            <span class="dash-titles">Change passwords</span>
          </a>
        </li>
        <li>
          <a href="candidates-delete-profile.php" class="tf-effect ">
                          ...
                          <div class="dec-wrap flex2">
                            ...
                            <div class="content">
                              ...
                              <div class="title-box fs-12 fw-5">
                                <span>Meeting with: </span> <a class="color-3" href="#">SamSung</a>
                              </div>
                          ...
                          <div class="dec-wrap flex2">
                            ...
                            <div class="content">
                              ...
                              <div class="fs-12 fw-5">
                                <span>Meeting with: </span> <a href="#" class="color-3">SamSung</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
