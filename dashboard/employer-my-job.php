...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-my-job.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:39 GMT -->
<head>
  <!-- Basic Page Needs -->
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr class="file-delete">
                        ...
                        <td>
                          <h6 class="fw-5">Created: Oct 18, 2022</h6>
                          <h6 class="fw-5">Expiry date: Sept 5, 2023</h6>
                        </td>
                        <td>
                          <div class="status-wrap">
                            <div class="button-status color-3"> Published </div>
                          </div>
                        </td>
                        <td>
                          <div class="action-wrap">
                            <ul class="flex2">
                              <li class="hv-tool" data-tooltip="Lock"><a class="action-icon icon-lock1"></a></li>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="candidates-wrap flex2">
                            <div class="content">
                              <div class="title-box">
                                <h3>Intern Digital Marketing</h3>
                              </div>
                              <div class="now-box flex2">
                                <div class="map color-4">Tokyo, Japan</div>
                              </div>
