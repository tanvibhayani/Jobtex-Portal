...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/candidates-delete-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:32 GMT -->
<head>
  <!-- Basic Page Needs -->
...
<body class="dashboard show ">
    ...
    <div class="widget-filter">
      <div class="mobile-header">
        <div id="logo" class="logo">
          <a href="home-01.php">
            <img class="site-logo" src="images/logo.php" alt="Image" />
          </a>
        </div>
  ...
  <div class="dashboard__content">
    ...
    <section class="flat-dashboard-bottom st2">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
