...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-alerts-candidate.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:41 GMT -->
<head>
  <!-- Basic Page Needs -->
...
<body class="dashboard show ">
  ...
  <div class="dashboard__content">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="title-dashboard">
              <div class="title-dash flex2">Alerts Candidate</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="flat-dashboard-alerts flat-dashboard-applicants">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr class="file-delete">
                        ...
                        <td>
                          <ul>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Type: </span> <span
                                class="color-1 fw-6">Full Time</span> </li>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Applied Date: </span> <span
                                class="color-1 fw-6">All</span> </li>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Experience: </span> <span
                                class="color-1 fw-6">2 Years</span> </li>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Career Level: </span> <span
                                class="color-1 fw-6">Officer</span> </li>
                          </ul>
                        </td>
                        <td>
                          <div>Candidate found 21</div>
                        </td>
                        <td>
                          <div class="times-wrap center">
                            <a class="fw-7 color-3"> Daily</a>
                          </div>
                        </td>
                        <td>
                          <div class="remove-file" data-tooltip="Cancel"><a class="cancel-icon icon-cancel"></a></div>
                        </td>
                      </tr>
                      <!-- col 2 -->
                      <tr class="file-delete">
                        ...
                        <td>
                          <ul>
                            <li class="fs-12 fw-5"><span class="color-4">Type: </span> <span class="color-1">Full
                                Time</span> </li>
                            <li class="fs-12 fw-5"><span class="color-4">Applied Date: </span> <span
                                class="color-1">All</span> </li>
                            <li class="fs-12 fw-5"><span class="color-4">Experience: </span> <span class="color-1">2
                                Years</span> </li>
                            <li class="fs-12 fw-5"><span class="color-4">Career Level: </span> <span
                                class="color-1">Officer</span> </li>
                          </ul>
                        </td>
                        <td>
                          <div>Candidate found 08</div>
                        </td>
                        <td>
                          <div class="times-wrap center">
                            <a class="fw-7 color-3"> weekly</a>
                          </div>
                        </td>
                        <td>
                          <div class="remove-file" data-tooltip="Cancel"><a class="cancel-icon icon-cancel"></a></div>
