...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:39 GMT -->
<head>
  <!-- Basic Page Needs -->
          ...
          <div class="col-lg-12 col-md-12 ">
            <div class="wrap-profile flex2 bg-white">
              ...
              <div class="box-profile flex2">
                <div class="images">
                  <img src="../images/dashboard/profile-1.jpg" alt="">
                </div>
                <div class="content">
                  ...
                  <div class="map color-4">Las Vegas, NV 89107, USA</div>
                </div>
              </div>
              <div class="tt-button">
          ...
          <div class="col-lg-12 col-md-12 ">
            <div class="wrap-about flex">
              <div class="side-bar">
                <div class="sidebar-map bg-white">
                  ...
                  <div class="title-box flex">
                    <div class="p-16">Website</div><a href="#">
                      <h4 class="color-3">avitex.vn</h4>
                    </a>
                  </div>
                  <div class="title-box flex">
                    <div class="p-16">Email</div>
                    <h4><a href="info:hi.avitex@gmail.com">hi.avitex@gmail.com</a></h4>
                  </div>
                  <div class="title-box flex">
                    <div class="p-16">Industry</div>
                    <h4>Internet Publishing</h4>
                  </div>
                  <div class="title-box flex">
                    <div class="p-16">Company size</div>
                    <h4>51-200 Employees</h4>
                  </div>
                  <div class="title-box flex">
                    <div class="p-16">Headquarters</div>
                    <h4>Valley , Las Vegas, USA</h4>
                  </div>
                  <div class="title-box flex">
                  ...
                  <div class="wrap-icon">
                    ...
                    <div class="box-icon flex">
                      ...
                      <a href="#" class="icon-instagram1"></a>
                      <a href="#" class="icon-youtube"></a>
                    </div>
                  </div>
                </div>
                <div class="sidebar-extended">
                  <h4 class="fw-7">Extended</h4>
                  <div class="month-box flex"><span class="fw-6">$79.00</span>
                    <h5>/month</h5>
                  </div>
                  <p>Upgrade your plan from a Free trial, to ‘Premium Plan’</p>
                  <div class="images">
                    <img src="../images/dashboard/sidebar-1.png" alt="">
                  </div>
                  <div class="tt-button">
                    <a href="#" class="btn-3">Upgrade Plan</a>
                  </div>
                </div>
              </div>
              ...
              <div class="post-about widget-dash-video bg-white">
                ...
                <p class="text-1">Are you a User Experience Designer with a track record of delivering intuitive digital
                  experiences that drive results? Are you a strategic storyteller and systems thinker who can concept
                  and craft smart, world-class campaigns across a variety of mediums?</p>
                <p class="text-2">Deloitte's Green Dot Agency is looking to add a Lead User Experience Designer to our
                  ...
                  experiences under tight deadlines; and who has demonstrated proven expertise.</p>
                <div class="video-wrap gallery">
                  <div class="swiper-item gallery-slide">
                  ...
                  <div class="swiper-item gallery-thumb">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide swiper-slide-1">
                    ...
                    <div class="button-custom-slider">
                      <div class="swiper-button-next3 button-slide-custom-next"><span
                          class="icon-keyboard_arrow_right"></span></div>
                      <div class="swiper-button-prev3 button-slide-custom-prev"><span
                          class="icon-keyboard_arrow_left"></span> </div>
                    </div>
                  </div>


                </div>
                <h3 class="title-jobs">Available Jobs</h3>
                <div class="profile-wrap">
                  <div class="box box-1">
                    <div class="inner">
                      <div class="image-box flex2">
                        <div class="images">
                          <img src="../images/dashboard/profile-2.jpg" alt="">
                        </div>
                        <div class="content">
                          <h5 class="color-3 fw-6">Tamari Law Group LLC</h5>
                          <div class="check-box flex2">
                            <a href="#">
                          ...
                          <div class="map-box flex2">
                            <div class="map color-4">Las Vegas, NV 89107, USA</div>
                            <div class="day color-4">2 days ago</div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="button-wrap flex2">
                      <div class="button-box">
                        <a href="#" class="time">Part-time</a>
                        <a href="#" class="remote">Remote</a>
                      </div>
                      <span class="star">
                        ...
                        <i class="icon-star-full"></i>
                        <i class="icon-star-full"></i>
                        <i class="icon-star-full style"></i>
                      </span>
                    </div>
                    <div class="days-wrap flex">
                      <div class="days-box flex2"><span class="icon-dolar1"></span> <span
                          class="fw-6 fs-16 money">$83,000 - $110,000 </span>
                        <p>/year</p>
                      </div>
                      <h5 class="fs-14">22 days left to apply</h5>
                    </div>
                  </div>
...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:40 GMT -->
</html>