...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-my-packages.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:41 GMT -->
<head>
  <!-- Basic Page Needs -->
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="title-dashboard">
              <div class="title-dash flex2">My Packages</div>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="fs-16">1</div>
                        </td>
                        <td>
                          <div class="fs-16">6508</div>
                        </td>
                        <td>
                          <div class="status-wrap">
                            <div class="button-status style-2">basic</div>
                          </div>
                        </td>
                        <td>
                          <div class="fs-16">Job Package</div>
                        </td>
                        <td>
                          <ul>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Urgent: </span> <span
                                class="color-1 fw-6">Yes</span> </li>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Featured: </span> <span
                                class="color-1 fw-6">Yes</span> </li>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Poster: </span> <span
                                class="color-1 fw-6">0</span> </li>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Limit Posts: </span> <span
                                class="color-1 fw-6">30</span> </li>
                            <li class="fs-12 lh-24"><span class="color-4 fw-5">Listing Duration: </span> <span
                                class="color-1 fw-6">15</span> </li>
                          </ul>
                        </td>
                        <td>
                          <div class="times-wrap">
                            <a href="#" class="fw-7 color-3 fs-16"> Action</a>
                          </div>
                        </td>
                      </tr>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="fs-16">2</div>
                        </td>
                        <td>
                          <div class="fs-16">4567</div>
                        </td>
                        <td>
                          <div class="status-wrap">
                            <div class="button-status style">Standard</div>
                          </div>
                        </td>
                        <td>
                          <div class="fs-16">Job Package</div>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="fs-16">3</div>
                        </td>
                        <td>
                          <div class="fs-16">6746</div>
                        </td>
                        <td>
                          <div class="status-wrap">
                            <div class="button-status color-3">Extended</div>
                          </div>
                        </td>
                        <td>
                          <div class="fs-16">Job Package</div>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="fs-16">4</div>
                        </td>
                        <td>
                          <div class="fs-16">1254</div>
                        </td>
                        <td>
                          <div class="status-wrap">
                            <div class="button-status style-2">basic</div>
