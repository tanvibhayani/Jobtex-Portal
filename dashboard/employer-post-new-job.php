...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-post-new-job.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:41 GMT -->
<head>
  <!-- Basic Page Needs -->
  ...
  <div class="menu-mobile-popup">
    ...
    <div class="widget-filter">
                  ...
                  <li class="menu-item menu-item-has-children-mobile">
                    ...
                    <ul class="sub-menu-mobile">
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-01.php">Home Page 01 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../Home-02.php">Home Page 02 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-03.php">Home Page 03 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-04.php">Home Page 04 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-05.php">Home Page 05 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-06.php">Home Page 06 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-07.php">Home Page 07 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-08.php">Home Page 08 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-09.php">Home Page 09 </a>
                      </li>
                      <li class="menu-item menu-item-mobile">
                        <a href="../home-10.php">Home Page 10 </a>
                      </li>
                    </ul>
                  </li>
                  <li class="menu-item menu-item-has-children-mobile">
      ...
      <div class="header-customize-item button">
        <a href="employer-my-job.php">Post Job</a>
      </div>
          ...
          <div class="sticky-area-wrap">
                  ...
                  <ul id="menu-primary-menu" class="menu">
                    ...
                    <li class="menu-item menu-item-has-children">
                      ...
                      <ul class="sub-menu st1">
                        <li class="nav-sub">
                          <a href="#">Jobs Listing <span class="icon-keyboard_arrow_right"></span> </a>
                    ...
                    <li class="menu-item menu-item-has-children">
                      ...
                      <ul class="sub-menu st1">
                        <li class="nav-sub">
                          <a href="#">Employers Listing <span class="icon-keyboard_arrow_right"></span> </a>
                    ...
                    <li class="menu-item menu-item-has-children ">
                      ...
                      <ul class="sub-menu st1">
                        <li class="nav-sub">
                          <a href="#">Candidates Listing <span class="icon-keyboard_arrow_right"></span> </a>
            ...
            <div class="header-ct-right">
              <div class="header-customize-item help">
                <a href="../term-of-use.php"><span class="icon-help-circle"></span></a>
              </div>
              ...
              <div class="header-customize-item account">
                ...
                <div class="name">
                  Employer<span class="icon-keyboard_arrow_down"></span>
                </div>
                <div class="sub-account">
                  <div class="sub-account-item">
                    <a href="employer-dashboard.php"><span class="icon-dashboard"></span>Dashboard</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-profile.php"><span class="icon-profile"></span> Profile</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-my-job.php"><span class="icon-work"></span> My Job</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-submit-job.php"><span class="icon-submit"></span> Submit Job</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-saved-candidates.php"><span class="icon-save-candidate"></span> Saved
                      Candidate</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-alerts-candidate.php"><span class="icon-bell1"></span> Candidate Alerts</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-my-packages.php"><span class="icon-mypackage "></span> My Packages</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-messages.php"><span class="icon-chat"></span> Messages</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-meetings.php"><span class="icon-meeting"></span> Meeting</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-change-passwords.php"><span class="icon-change-passwords"></span> Change
                      Passwords</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="employer-delete-profile.php"><span class="icon-trash"></span> Delete Profile</a>
                  </div>
                  <div class="sub-account-item">
                    <a href="../home-01.php"><span class="icon-log-out"></span> Log Out</a>
                  </div>
                </div>
              </div>
              <div class="header-customize-item button">
  ...
  <div class="left-menu">
    ...
    <div id="sidebar-menu">
      ...
      <ul class="downmenu list-unstyled" id="side-menu">
        ...
        <li>
          <a href="employer-dashboard.php" class="tf-effect">
        ...
        <li>
          ...
          <ul class="sub-menu2" aria-expanded="false">
            ...
            <li><a href="employer-profile-setting.php">Profile Setting</a></li>
            <li><a href="employer-post-new-job.php">Post New Job</a></li>
          </ul>
        </li>

        <li>
          <a href="employer-my-job.php" class="tf-effect">
            <span class="icon-work dash-icon"></span>
            <span class="dash-titles">My Job</span>
          </a>
        </li>

        <li>
          <a href="employer-submit-job.php" class=" tf-effect">
        ...
        <li>
          <a href="employer-applicants-jobs.php" class="tf-effect">
        ...
        <li>
          <a href="employer-saved-candidates.php" class="tf-effect">
        ...
        <li>
          <a href="employer-alerts-candidate.php" class="tf-effect">
        ...
        <li>
          <a href="employer-my-packages.php" class="tf-effect">
        ...
        <li>
          <a href="employer-messages.php" class="tf-effect">
        ...
        <li>
          <a href="employer-meetings.php" class="tf-effect">
        ...
        <li>
          <a href="employer-change-passwords.php" class="tf-effect">
            <span class="icon-change-passwords dash-icon"></span>
            <span class="dash-titles">Change passwords</span>
          </a>
        </li>

        <li>
          <a href="employer-delete-profile.php" class="tf-effect ">
        ...
        <li>
          <a href="../home-01.php" class="tf-effect">
  ...
  <div class="dashboard__content">
    ...
    <section class="flat-dashboard-post flat-dashboard-setting">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="post-new profile-setting bg-white">
              <h3 class="title-img">Featured Image <span class="color-red">*</span> </h3>
              <div class="btn-wrap button-wrap flex2">
                <div class="tt-button button-browse">
                  <a href="#">Browse</a>
                </div>
                <div class="fs-16 "><a class="color-4">Upload image</a> </div>
              </div>
              <div class="wrap-titles">
                <h3 class="title-img">Job Title <span class="color-red">*</span> </h3>
                <fieldset class="info-wd">
                  <input type="text" class="input-form" value="UI UX Designer">
                </fieldset>
              </div>
              <div class="text-editor-wrap">
                <h3 class="title-img">Job Description <span class="color-red">*</span> </h3>
              ...
              <div class="form-infor flex flat-form">
                <div class="info-box info-wd">
                  <div id="item_category" class="dropdown titles-dropdown">
                    <label class="title-user fw-7">Category</label>
                    <a class="btn-selector nolink input-form"> Accountng/ Finance</a>
                    <ul>
                      <li><span>Accountng/ Finance</span></li>
                      <li><span>User/ Finance</span></li>
                      <li><span>Admin/ Finance</span></li>
                    </ul>
                  </div>
                  <fieldset>
                    <label class="title-user fw-7">Tag</label>
                    <input type="text" class="input-form" required>
                  </fieldset>
                  <div id="item_apply" class="dropdown titles-dropdown">
                    <label class="title-user fw-7">Job Apply Type</label>
                    <a class="btn-selector nolink input-form"> Internal</a>
                    <ul>
                      <li><span>Internal</span></li>
                      <li><span>Junior</span></li>
                      <li><span>Mid Level</span></li>
                  ...
                  <div id="item_qualification" class="dropdown titles-dropdown">
                    <label class="title-user fw-7">Qualification</label>
                    <a class="btn-selector nolink input-form"> Certificate </a>
                    <ul>
                ...
                <div class="info-box info-wd">
                  <div id="item_1" class="dropdown titles-dropdown ">
                    <label class="title-user fw-7">Type</label>
                    <a class="btn-selector nolink input-form"> Freelance </a>
                    <ul>
                  ...
                  <div id="item_2" class="dropdown titles-dropdown ">
                    <label class="title-user fw-7">Gender</label>
                    <a class="btn-selector nolink input-form"> Male</a>
                    <ul>
                      <li><span>10 - 50</span></li>
                      <li><span>50 - 120</span></li>
                      <li><span>120 - 500</span></li>
                    </ul>
                  </div>
                  <fieldset>
                  ...
                  <div id="item_3" class="dropdown titles-dropdown ">
                    <label class="title-user fw-7">Salary Type</label>
                    <a class="btn-selector nolink input-form"> Month</a>
                    <ul>
                      <li><span>1</span></li>
                      <li><span>6</span></li>
                      <li><span>12</span></li>
                  ...
                  <fieldset>
                    ...
                    <input type="text" class="input-form" value="Master Degree" required>
                  </fieldset>

                  <div id="item_4" class="dropdown titles-dropdown ">
                    <label class="title-user fw-7">Career Level</label>
                    <a class="btn-selector nolink input-form"> Manager</a>
                    <ul>
                      <li><span>Managerial</span></li>
                      <li><span>Manager</span></li>
                      <li><span>Personnel</span></li>
                    </ul>
                  </div>
                  <fieldset>
                    <label class="title-user fw-7">Introduction Video URL</label>
                    <input type="url" class="input-form" required>
                  </fieldset>
                </div>
              </div>
              ...
              <div class="btn-wrap button-wrap flex2">
                <div class="tt-button button-browse">
                  <a href="#" class="btn-3">Browse</a>
                </div>
                <div class="fs-16"><a>Upload image, video</a> </div>
              </div>
              <div class="contact-wrap info-wd">
                <h3>Location</h3>
                <div class="form-map form-wg flex flat-form">
                  <div class="form-box  wg-box">
                    <fieldset class="">
                      <label class="title-user fs-16"> Address</label>
                      <input type="text" class="input-form" value="Las Vegas, NV 89107, USA">
                    </fieldset>
                  </div>
                  <div class="form-box  wg-box">
                    <div id="item_category2" class="dropdown titles-dropdow">
                      <label class="title-user fs-16">Location</label>
                ...
                <fieldset class="address-box">
                  <label class="title-user fs-16">Map Location</label>
              ...
              <div class="area-wrap info-wd">
                <div class="form-social form-wg flex flat-form">
                  <div class="form-box  wg-box">
                    <fieldset class="">
                      <input type="text" class="input-form input-style" value="40.69499198068389">
                    </fieldset>
                  </div>
                  <div class="form-box  wg-box">
                    <fieldset class="">
                      <input type="text" class="input-form input-style" value="-73.9959976171989">
                    </fieldset>
                  </div>
                </div>
              </div>
              <div class="wrap-video">
                <fieldset class="info-wd">
                  <label class="title-url fw-4 fs-16 color-4">Introduction Video</label>
                  <input type="url" class="input-form input-style" value="https://www.youtube.com/watch?v=I6ZLgk_bq90">
                </fieldset>
              </div>
            </div>
          </div>
