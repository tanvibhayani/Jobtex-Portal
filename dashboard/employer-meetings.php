...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-meetings.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:41 GMT -->
<head>
  <!-- Basic Page Needs -->
...
<body class="dashboard show ">
  ...
  <div class="dashboard__content">
    <section class="page-title-dashboard style style2">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="title-dashboard flex2">
              <div class="title-dash flex2">Meetings</div>
              <div class="tt-button">
                <a href="#" class="btn-3">Zoom Setting</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="flat-dashboard-meetings flat-dashboard-applicants">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="dec-wrap flex2">
                            <div class="dec-box">
                              <div class="title-dec fw-7 flex3">DEC</div>
                              <div class="dec fw-7 flex3">06</div>
                            </div>
                            <div class="content">
                              <h4 class="fw-7">Marketer</h4>
                              <div class="title-box fs-12 fw-5">
                                <span>Meeting with: </span> <a class="color-3" href="#">Tony Nguyen</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
                                <div class="time-1 flex2">3h: 00 </div>
                                <div class="time-2 flex2">30m</div>
                              </div>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="action-wrap">
                            <ul class="flex2">
                              ...
                              <li class="hv-tool" data-tooltip="Re-schedule Meeting"><a
                                  class="action-icon style icon-calendar_today"></a></li>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="dec-wrap flex2">
                            <div class="dec-box">
                              <div class="title-dec fw-7 flex3">DEC</div>
                              <div class="dec fw-7 flex3">07</div>
                            </div>
                            <div class="content">
                              <h4 class="fw-7">Junior Graphic Designer</h4>
                              <div class="fs-12 fw-5">
                                <span>Meeting with: </span> <a href="#" class="color-3">Daniel Crumi</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
                                <div class="time-1">3h: 00 </div>
                                <div class="time-2">30m</div>
                              </div>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="dec-wrap flex2">
                            <div class="dec-box">
                              <div class="title-dec fw-7 flex3">DEC</div>
                              <div class="dec fw-7 flex3">08</div>
                            </div>
                            <div class="content">
                              <h4 class="fw-7">Digital Marketing</h4>
                              <div class="fs-12 fw-5">
                                <span>Meeting with: </span> <a href="#" class="color-3">Danimia</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
                                <div class="time-1">3h: 00 </div>
                                <div class="time-2">30m</div>
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="dec-wrap flex2">
                            <div class="dec-box">
                              <div class="title-dec fw-7 flex3">DEC</div>
                              <div class="dec fw-7 flex3">09</div>
                            </div>
                            <div class="content">
                              <h4 class="fw-7">Project Manager</h4>
                              <div class="fs-12 fw-5">
                                <span>Meeting with: </span> <a href="#" class="color-3">Danimia</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="dec-wrap flex2">
                            <div class="dec-box">
                              <div class="title-dec fw-7 flex3">DEC</div>
                              <div class="dec fw-7 flex3">11</div>
                            </div>
                            <div class="content">
                              <h4 class="fw-7">Director</h4>
                              <div class="fs-12 fw-5">
                                <span>Meeting with: </span> <a href="#" class="color-3">Danimia</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="dec-wrap flex2">
                            <div class="dec-box">
                              <div class="title-dec fw-7 flex3">DEC</div>
                              <div class="dec fw-7 flex3">13</div>
                            </div>
                            <div class="content">
                              <h4 class="fw-7">UI UX Designer</h4>
                              <div class="fs-12 fw-5">
                                <span>Meeting with: </span> <a href="#" class="color-3">Danimia</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
                      ...
                      <tr class="file-delete">
                        <td>
                          <div class="dec-wrap flex2">
                            <div class="dec-box">
                              <div class="title-dec fw-7 flex3">DEC</div>
                              <div class="dec fw-7 flex3">14</div>
                            </div>
                            <div class="content">
                              <h4 class="fw-7">Digital Marketing</h4>
                              <div class="fs-12 fw-5">
                                <span>Meeting with: </span> <a class="color-3" href="#">Danimia</a>
                              </div>
                              <div class="time-box flex2 fs-12 fw-5">
                                <div class="time-1">3h: 00 </div>
                                <div class="time-2">30m</div>
