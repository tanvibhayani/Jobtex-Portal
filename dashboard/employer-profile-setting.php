...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/employer-profile-setting.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:41 GMT -->
<head>
  <!-- Basic Page Needs -->
              ...
              <div class="form-infor-profile">
                ...
                <div class="form-infor flex flat-form">
                  <div class="info-box info-wd">
                    <fieldset>
                      <label class="title-user fw-7">Employer Name</label>
                  ...
                  <div class="info-box info-wd">
                    <fieldset>
                      ...
                      <input type="email" class="input-form" value="hi.avitex@gmail.com" required>
                    </fieldset>
                    <fieldset>
                      <label class="title-user fw-7">Website</label>
                      <input type="url" class="input-form" required>
                    </fieldset>
                    <div id="item_size" class="dropdown titles-dropdown ">
                      <label class="title-user fw-7">Company Size</label>
                      <a class="btn-selector nolink input-form"> 50 - 120</a>
                      <ul>
                ...
                <div class="tag-wrap">
                  <h5 class="title-tag fw-7">Categories <span class="color-red">*</span></h5>
                ...
                <div class="wrap-url border-bt">
                  <fieldset class="info-wd">
                    <label class="title-url fw-7">Profile URL</label>
                    <input type="url" class="input-form">
                  </fieldset>
                </div>
