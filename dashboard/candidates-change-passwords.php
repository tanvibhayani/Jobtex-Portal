...
<!-- Mirrored from themesflat.co/html/jobtex/dashboard/candidates-change-passwords.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 02 May 2025 13:29:32 GMT -->
<head>
  <!-- Basic Page Needs -->
...
<body class="dashboard show ">
  ...
  <div class="dashboard__content">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="title-dashboard">
              <div class="title-dash flex2">Change Passwords</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
            <div class="change-password bg-white">
              <form action="https://themesflat.co/html/jobtex/dashboard/dashboard.php">
                <div class="form-password">
                  <h3>Change Password</h3>
                  <div class="pass-box">
                    <div class="inner info-wd">
                      <label class="title-url fs-16">Old Password</label>
                    ...
                    <div class="inner info-wd">
                      <label class="title-url fs-16">New Password</label>
                      <div class="inputs-group auth-pass-inputgroup relative flex2">
                    ...
                    <div class="inner info-wd">
                      <label class="title-url fs-16">Retype New Password</label>
                      <div class="inputs-group auth-pass-inputgroup relative flex2">
                        <input type="password" class="input-form password-input" value="123456789flat123" required>
                    ...
                    <div class="tt-button submit">
                      <a class="btn-3">Change Password</a>
                    </div>
                  </div>
                </div>
              </form>
    ...
    <section class="flat-dashboard-bottom st3">
      <div class="themes-container">
        <div class="row">
          <div class="col-lg-12 col-md-12 ">
