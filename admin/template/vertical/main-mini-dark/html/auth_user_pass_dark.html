...
<!-- Mirrored from employx-admin-templates.multipurposethemes.com/html/template/vertical/main-mini-dark/auth_user_pass_dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 27 Jun 2025 09:55:19 GMT -->
<head>
  <meta charset="utf-8">
    ...
    <title>EmployX - Recover Password</title>
				...
				<div class="row justify-content-center g-0">
					<div class="col-lg-5 col-md-5 col-12">						
						<div class="bg-gray-800 rounded10 shadow-lg">
							...
							<div class="p-40">
								<form action="https://employx-admin-templates.multipurposethemes.com/html/template/vertical/main-mini-dark/index.html" method="post">
