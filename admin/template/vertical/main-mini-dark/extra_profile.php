							...
							<div>
								<div class="d-flex align-items-center mb-30">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="#" class="text-info hover-primary mb-1 fs-16">Sophia</a>
								...
								<div class="d-flex align-items-center mb-30">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="#" class="text-info hover-danger mb-1 fs-16">Mason</a>
								...
								<div class="d-flex align-items-center mb-30">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="#" class="text-info hover-success mb-1 fs-16">Emily</a>
								...
								<div class="d-flex align-items-center mb-30">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="#" class="text-info hover-info mb-1 fs-16">Daniel</a>
								...
								<div class="d-flex align-items-center">
									...
									<div class="d-flex flex-column flex-grow-1">
										<a href="#" class="text-info hover-warning mb-1 fs-16">Natalie</a>
